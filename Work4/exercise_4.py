...
def main():
    ...
    # Apply PCA
    projected_data = pca.fit_transform(df_satimage).values

    # Print unique labels (optional for debugging)
    print(projected_data)
    print(np.unique(labels_satimage))

    # Plot PCA subspace
    pca.plot_pca_subspace(projected_data, labels_satimage)
